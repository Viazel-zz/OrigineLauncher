...
function showMainUI(data){
    ...
    setTimeout(() => {
        ...
        if(ConfigManager.isFirstLaunch()){
            ...
            if(hasRPC){
                DiscordWrapper.updateDetails('Bienvenue et continue.')
                DiscordWrapper.updateState('Setup Launcher')
            }
        } else {
            if(isLoggedIn){
    ...
    setTimeout(() => {
        $('#loadingContainer').fadeOut(250, () => {
            ...
            setOverlayContent(
                ...
                'Une connexion n\'a pas pu être établie avec nos serveurs pour télécharger l\'index de distribution. Aucune copie locale n\'était disponible pour le chargement. <br><br>L\'index de distribution est un fichier essentiel qui fournit les dernières informations sur le serveur. Le lanceur ne peut pas démarrer sans lui. Assurez-vous d\'être connecté à Internet et relancez l\'application. <br><br>Il est très possible que le lanceur ait mis à jour et modifié l\'emplacement du fichier d\'index de distribution. Nous vous recommandons d\'installer la dernière version du lanceur à partir de notre page de versions. <br><br>Si vous continuez à rencontrer des problèmes, veuillez nous contacter sur le serveur Origine Discord.',
